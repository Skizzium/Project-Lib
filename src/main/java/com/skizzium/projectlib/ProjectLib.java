...
//        private final PL_ServerBossEvent bossBar = new PL_ServerBossEvent(this.getDisplayName(), PL_BossEvent.PL_BossBarColor.PINK, PL_BossEvent.PL_BossBarOverlay.PROGRESS);
//        
