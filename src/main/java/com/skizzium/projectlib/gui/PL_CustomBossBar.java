...
public class PL_CustomBossBar extends PL_ServerBossEvent {
    private final ResourceLocation id;
    private final Set<UUID> players = Sets.newHashSet();
    private int value;
    private int max = 100;
    
    public PL_CustomBossBar(Entity entity, Component displayName, int color, PL_BossBarOverlay overlay) {
        super(entity, displayName, color, overlay);
        this.id = p_136261_;
        this.setProgress(0.0F);
    }

    public PL_CustomBossBar(Entity entity, Component displayName, SoundEvent music, int color, PL_BossBarOverlay overlay) {
        super(entity, displayName, music, color, overlay);
        this.id = p_136261_;
        this.setProgress(0.0F);
    }

    public PL_CustomBossBar(Entity entity, Component displayName, PL_BossBarColor color, PL_BossBarOverlay overlay) {
        super(entity, displayName, color, overlay);
        this.id = p_136261_;
        this.setProgress(0.0F);
    }

    public PL_CustomBossBar(Entity entity, Component displayName, SoundEvent music, PL_BossBarColor color, PL_BossBarOverlay overlay) {
        super(entity, displayName, music, color, overlay);
        this.id = p_136261_;
        this.setProgress(0.0F);
    }
