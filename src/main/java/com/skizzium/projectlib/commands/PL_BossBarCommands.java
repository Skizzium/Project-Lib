...
public class PL_BossBarCommands {
    ...
    private static final SuggestionProvider<CommandSourceStack> SUGGEST_BOSS_BAR = (p_136587_, p_136588_) -> SharedSuggestionProvider.suggestResource(p_136587_.getSource().getServer().getCustomBossEvents().getIds(), p_136588_);
        ...
        return Commands.literal("bossbar").requires((p_136627_) -> p_136627_.hasPermission(2))
                .then(Commands.literal("add")
                        ...
                        .then(Commands.argument("name", ComponentArgument.textComponent())
                            .executes((p_136693_) -> createBar(p_136693_.getSource(), ResourceLocationArgument.getId(p_136693_, "id"), ComponentArgument.getComponent(p_136693_, "name"))))))
                ...
                .then(Commands.literal("set")
                        .then(Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR)
                            .then(Commands.literal("name")
                                .then(Commands.argument("name", ComponentArgument.textComponent())
                                    .executes((p_136687_) -> setName(p_136687_.getSource(), getBossBar(p_136687_), ComponentArgument.getComponent(p_136687_, "name")))))
                            .then(Commands.literal("color")
                                .then(Commands.literal("pink")
                                    .executes((parameter) -> setColor(parameter.getSource(), getBossBar(parameter), BossEvent.BossBarColor.PINK)))
                            ...
                            .then(Commands.literal("style")
                                .then(Commands.literal("progress")
                                    .executes((p_136671_) -> setStyle(p_136671_.getSource(), getBossBar(p_136671_), BossEvent.BossBarOverlay.PROGRESS)))
                                .then(Commands.literal("notched_6")
                                    .executes((p_136669_) -> setStyle(p_136669_.getSource(), getBossBar(p_136669_), BossEvent.BossBarOverlay.NOTCHED_6)))
                                .then(Commands.literal("notched_10")
                                    .executes((p_136667_) -> setStyle(p_136667_.getSource(), getBossBar(p_136667_), BossEvent.BossBarOverlay.NOTCHED_10)))
                                .then(Commands.literal("notched_12")
                                    .executes((p_136665_) -> setStyle(p_136665_.getSource(), getBossBar(p_136665_), BossEvent.BossBarOverlay.NOTCHED_12)))
                                .then(Commands.literal("notched_20")
                                    .executes((p_136663_) -> setStyle(p_136663_.getSource(), getBossBar(p_136663_), BossEvent.BossBarOverlay.NOTCHED_20))))
                            .then(Commands.literal("value")
                                .then(Commands.argument("value", IntegerArgumentType.integer(0))
                                    .executes((p_136661_) -> setValue(p_136661_.getSource(), getBossBar(p_136661_), IntegerArgumentType.getInteger(p_136661_, "value")))))
                            .then(Commands.literal("max")
                                .then(Commands.argument("max", IntegerArgumentType.integer(1))
                                    .executes((p_136659_) -> setMax(p_136659_.getSource(), getBossBar(p_136659_), IntegerArgumentType.getInteger(p_136659_, "max")))))
                            .then(Commands.literal("visible")
                                .then(Commands.argument("visible", BoolArgumentType.bool())
                                    .executes((p_136657_) -> setVisible(p_136657_.getSource(), getBossBar(p_136657_), BoolArgumentType.getBool(p_136657_, "visible")))))
                            .then(Commands.literal("players")
                                .executes((p_136655_) -> setPlayers(p_136655_.getSource(), getBossBar(p_136655_), Collections.emptyList()))
                            .then(Commands.argument("targets", EntityArgument.players())
                                .executes((p_136653_) -> setPlayers(p_136653_.getSource(), getBossBar(p_136653_), EntityArgument.getOptionalPlayers(p_136653_, "targets")))))))
                .then(Commands.literal("get")
                        .then(Commands.argument("id", ResourceLocationArgument.id()).suggests(SUGGEST_BOSS_BAR)
                            .then(Commands.literal("value")
                                .executes((p_136648_) -> getValue(p_136648_.getSource(), getBossBar(p_136648_))))
                            .then(Commands.literal("max")
                                .executes((p_136643_) -> getMax(p_136643_.getSource(), getBossBar(p_136643_))))
                            .then(Commands.literal("visible")
                                .executes((p_136638_) -> getVisible(p_136638_.getSource(), getBossBar(p_136638_))))
                            .then(Commands.literal("players")
                                .executes((p_136625_) -> getPlayers(p_136625_.getSource(), getBossBar(p_136625_))))));
    }
    ...
    private static CustomBossEvent getBossBar(CommandContext<CommandSourceStack> pSource) throws CommandSyntaxException {
